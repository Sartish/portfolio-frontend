      ...
      <VerticalTimeline>
        ...
        >
          ...
          <p contentStyle={{ fontWeight: "800" }}>
            Developer for clients, mainly in the frontend team, using React.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            Frontend developer bootcamp student and code coach in CSS and basic
            JavaScript.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <p>Consultant mainly within SAP and test management.</p>
        </VerticalTimelineElement>
        ...
        >
          ...
          <p>Professional scrum master certification (PSM 1).</p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--education"
          date="2017-2019"
        ...
        >
          ...
          <p>Master degree from Copenhagen business school.</p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--education"
          date="2015-2017"
        ...
        >
          ...
          <p>Business & marketing and minor in sociology.</p>
        </VerticalTimelineElement>
      </VerticalTimeline>
    </div>
  );
