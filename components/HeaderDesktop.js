	...
	return (
		<header className="w-full h-screen lg:h-screen  flex justify-evenly lg:justify-start items-center flex-col mb-[25px] lg:[mb-0px]">
			<div className="flex justify-center items-center flex-col lg:flex-row md:flex-col w-[90%] mt-[-40px]">
				...
				<div data-aos="fade-right" className="flex justify-center items-center flex-col lg:min-w-fit z-10">
			...
			<h1 data-aos="fade-up" className="text-center font-Lora text-[12px] md:text-[18px] mt-[-80px] lg:pt-[100px] md:mb-[30px]">using my passion to help you pursue yours
