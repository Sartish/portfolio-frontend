		...
		<div className="w-screen flex justify-center items-center">
			<header className="w-full h-[500px] md:h-[500px] lg:h-1/2 flex flex-col lg:flex-row justify-between lg:justify-center items-center lg:items-start mt-[160px] mb-[50px] lg:mb-40 lg:pl-[60px] lg:pr-[45px]">
				...
				<div className="w-[400px] md:w-[600px] lg:w-[600px] flex justify-center items-center flex-col mt-20 lg:mt-5">
					...
					<h2 className="font-Rubik lg:text-4xl md:text-3xl text-3xl leading-normal p-4 text-center">I like <span className="bg-yellow bg-opacity-30 p-2">building</span> things for the <span>web</span></h2>
				</div>
			</header>
		</div>
